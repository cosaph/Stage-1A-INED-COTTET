...
'''
Le format de données géographiques "OGRGeoJSON" est un format de fichier qui permet de stocker des données spatiales sous forme de fichiers JSON.
...
mf_map(x=arr_c,
  ...
  col = colors,
  lwd = 1,
  leg_title = "Distribution de la population dans Paris", 
  digits = 0,
  add = TRUE)
