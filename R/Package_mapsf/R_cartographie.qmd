...
Nous allons vous présenter trois packages permettant de générer des cartes interactives : __sf__ , __mapview__ et __oceanis__. Il faut donc au préalable installer ces deux packages. 
install.packages("sf")
